(() => {
    ...
    function initSliders() {
        if (document.querySelector(".floor-plans__slider")) new core(".floor-plans__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".creek-rise__slider")) new core(".creek-rise__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        document.querySelectorAll(".popup__wrapper_second30");
        const popupSecond30 = document.querySelector("#popup-second30");
        const btnCloseSecond30 = document.querySelector(".second30-popap-close");
        function showPopupSecond30() {
            popupSecond30.classList.add("popup_show");
            document.querySelector("html").classList.add("popup-show");
            document.querySelector("html").classList.add("lock");
        }
        function closePopupSecond30() {
            popupSecond30.setAttribute("aria-hidden", "false");
            document.querySelector("html").classList.remove("popup-show");
            document.querySelector("html").classList.remove("lock");
            popupSecond30.classList.remove("popup_show");
        }
        setTimeout(showPopupSecond30, 3e4);
        btnCloseSecond30.addEventListener("click", closePopupSecond30);
        document.querySelector(".button-rise");
        document.querySelector(".button-cove");
        document.querySelector(".button-gate");
        const navButtons = document.querySelectorAll(".projects-block-nav__button");
        function smoothScrolling() {
            navButtons.forEach((item => {
                item.addEventListener("click", (event => {
                    event.preventDefault();
                    navButtons.forEach((j => {
                        j.classList.remove("nav-active");
                    }));
                    item.classList.add("nav-active");
                    if (item.classList.contains("button-cove")) document.querySelector(".the-cove-article").scrollIntoView({
                        behavior: "smooth",
                        block: "start"
                    }); else if (item.classList.contains("button-gate")) document.querySelector(".the-gate-article").scrollIntoView({
                        behavior: "smooth",
                        block: "start"
                    }); else if (item.classList.contains("button-rise")) document.querySelector(".the-rise-article").scrollIntoView({
                        behavior: "smooth",
                        block: "start"
                    });
                }));
